...
export const riversideTavernMap: DemoMapData = {
  ...
  description:
    'A cozy tavern by the river with a small village, perfect for starting adventures.',
  gridWidth: 30,
  gridHeight: 25,
  cellSize: 20,
...
export const mountainPassMap: DemoMapData = {
  ...
  description:
    'A narrow mountain pass with rocky terrain and scattered boulders, perfect for ambushes.',
  gridWidth: 25,
  gridHeight: 20,
  cellSize: 20,
  terrain: createTerrainFromPattern(
